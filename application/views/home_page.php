<main id="home-view">	
	<section id="registration">
		...
		<img src="public/img/mini-ipad.png">
	</section>
		...
		<article id="last-items">
			...
			<ul>
				<?php foreach ($tenProducts as $product):
					...
					<li><a href="<?php echo site_url($urlProduct); ?>"><img src="<?php echo relativeToAbsolute($product['img']); ?>"><?php echo character_limiter($product['titre'], 15); ?></a></li>
				<?php endforeach; ?>
			</ul>
		</article>
